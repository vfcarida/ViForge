...
import sys
from pathlib import Path
from viforge.config.loader import load_experiment_manifest
from viforge.training.runner import ExperimentRunner
from viforge.utils.logging import logger
...
def main():
    ...
    manifest = load_experiment_manifest(config_path)
